...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "MOVENTRA — Live City Bus Tracking" },
      {
        name: "description",
        content:
          "Choose how you want to use MOVENTRA: track buses as a passenger, run your trip as a driver, or monitor the fleet as an administrator.",
      },
      { property: "og:title", content: "MOVENTRA — Live City Bus Tracking" },
      {
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center px-4 py-10 sm:py-16">
        <header className="text-center">
          ...
          <p className="mt-3 text-base text-muted-foreground sm:text-lg">
            Choose how you want to use MOVENTRA
          </p>
        </header>
